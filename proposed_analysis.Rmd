...
The model will converge. The model will be compared to the models below (see notes below). After model selection, we will use the guidelines in the model improvement and alignment section to improve model fit. 
...
Factor structure: Multilevel CFA using a six-factor correlated model of each latent variable (DHF) separated by self/other distinction, and three-factor correlated model of the DHF latent variables will be analyzed. 
