...
H1A: A hierarchical model with three general factors of dignity, honor, and face, and six factors representing the self-concern and other-concern facet of each, will appropriately describe the data.
...
H1b-H1c: The hierarchical model will fit the data better than the more restrictive correlated 6-factor model (H1b), or a 3-factor model (H1c).
