...
table(dt6$Ultimatum.Proposer_1)
...
#correlation between self-reported negative reciprocity and behavioral negative reciprocity:r=0.108***
#correlation between self-reported positive reciprocity and behavioral negative reciprocity:r=-0.027***
#correlation between self-reported negative reciprocity and behavioral positive reciprocity:r=-0.038***  
```
...
##Testing main hypotheses (H3-H5) using personal endorsement for country-level aggregates
```{r h3-analysis}
# ============================================================================
# H3 ANALYSIS - MULTILEVEL PATH MODELS (using personal endorsement for country-level aggregates)
# ===========================================================================
...
# Level 2: Country-level personal endorsement predicting prosocial behavior  
...
# Level 2: Country-level personal endorsement predicting positive reciprocity
...
# Level 2: Country-level personal endorsement predicting negative reciprocity
...
# STEP 1: Prepare prosocial data (dt5) with 6-factor individual predictors + country-level personal endorsment
print("Preparing prosocial model data from dt5...")
DF_prosocial_H3_6factor <- dt5 %>%
  filter(!is.na(prosocial) & 
           !is.na(D_self_end) & !is.na(D_other_end) & 
...
# STEP 2: Prepare reciprocity data (dt6) with 6-factor individual predictors + country-level endorsement
print("Preparing reciprocity model data from dt6...")
DF_reciprocity_H3_6factor <- dt6 %>%
  filter(!is.na(UG_posrec) & !is.na(UG_negrec) & 
           !is.na(D_self_end) & !is.na(D_other_end) & 
...
# Level 2: Country-level endorsement predicting prosocial behavior  
prosocial ~ D_end_agg_CGM + H_end_agg_CGM + F_end_agg_CGM
'
...
# Level 2: Country-level endorsement predicting positive reciprocity
UG_posrec ~ D_end_agg_CGM + H_end_agg_CGM + F_end_agg_CGM
'
...
# Level 2: Country-level endorsement predicting negative reciprocity
UG_negrec ~ D_end_agg_CGM + H_end_agg_CGM + F_end_agg_CGM
'
...
#H3(supplementary) testing the same models with self-reported positive and negative reciprocity 
##(with country-level norms and country-level personal endorsement aggregates and with 3- and 6-factor individual-level predictors)

```{r h3-modelm supplementary; Self-reported measures}
# ============================================================================
...
#(suplementary)H4-H5 hypotheses using country-level personal endorsement aggregated
```{r h4-h5-model using country-level personal endorsement aggregated}
